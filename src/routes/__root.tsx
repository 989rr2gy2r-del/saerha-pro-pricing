...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  ...
  head: () => ({
    meta: [
      ...
      { title: "سعّرها — نظام التسعير الذكي" },
      {
        name: "description",
        content:
          "سعّرها: نظام التسعير الذكي التابع لشركة الأواب لتجارة الجملة والتجزئة لإدارة وتسعير طلبات الزبائن.",
      },
      { name: "author", content: "AL-AWAB FOR WHOLESALE & RETAIL TRADE CO." },
      { property: "og:title", content: "سعّرها — نظام التسعير الذكي" },
      {
        property: "og:description",
        content: "نظام ذكي لإدارة وتسعير طلبات الزبائن، تابع لشركة الأواب لتجارة الجملة والتجزئة.",
      },
